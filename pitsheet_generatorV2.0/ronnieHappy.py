...
canvas = Canvas(root, width=1035, height=800)
canvas.pack()
...
def bases(padding, segmentHeight, segmentWidth, segmentPadding, topPadding, offset, teamBoxOffsetx, teamBoxOffsety, teamBoxInitOffsetY, teamBoxHeight, teamBoxWidth, teamBoxItY, color, color2):
    # background
    if inkConservationMode == False:
        canvas.create_rectangle(0 + padding + offset, 0 + padding, segmentWidth + (segmentPadding * 2) + padding + offset,
    ...
    for i in range(3):
        ...
        canvas.create_rectangle(padding + segmentPadding + offset + 90, ((segmentHeight + segmentPadding) * i) + topPadding + segmentHeight - 30, padding + segmentPadding + 135 + offset, ((segmentHeight + segmentPadding) * i) + topPadding + segmentHeight, fill=color)
        ...
        for i in range(3):
            ...
            for x in range(3):
                ...
                canvas.create_rectangle(padding + segmentPadding + offset + teamBoxOffsetx + (teamBoxWidth * x), ((
                                                                                                         segmentHeight + segmentPadding) * i) + topPadding + teamBoxOffsety + teamBoxInitOffsetY + (y * teamBoxItY),
                                        padding + segmentPadding + offset + teamBoxOffsetx + teamBoxWidth + (teamBoxWidth * x), ((
                                                                                                                        segmentHeight + segmentPadding) * i) + topPadding + teamBoxOffsety + teamBoxInitOffsetY + teamBoxHeight + (y * teamBoxItY),
                                        fill=color)
    ...
    for i in range(3):
        ...
        for x in range(3):
            ...
            canvas.create_text(padding + segmentPadding + offset + teamBoxOffsetx + (teamBoxWidth * x) + (teamBoxWidth / 2), ((segmentHeight + segmentPadding) * i) + topPadding + teamBoxOffsety + teamBoxInitOffsetY - (teamBoxHeight / 2), text=localtext, font=(10))
    ...
    for y in range(4):
        ...
        for i in range(3):
            ...
            canvas.create_text(padding + segmentPadding + offset + teamBoxOffsetx - 30, ((segmentHeight + segmentPadding) * i) + topPadding + teamBoxOffsety + teamBoxInitOffsetY + (y * teamBoxItY) + (teamBoxHeight / 2), text=localtext, font=(10))

# def gameCalc():

def bars(color, color2):
    localPlaceholder = 200
    canvas.create_rectangle(310, 200, 310 + random.randint(0, 350) - 50, 175, fill=color)
    canvas.create_text(700, 177, text=random.randint(0, 350), font=('Arial', 15))
    canvas.create_rectangle(310, 210, 310 + random.randint(0, 350) + 5, 235, fill=color2)
    canvas.create_text(700, 222.5, text=random.randint(0, 350), font=('Arial', 15))

    canvas.create_text(517.5, 145, text='Auton Points', font=('Arial', 15))


    canvas.create_rectangle(310, 200 + 150, 310 + random.randint(0, 350) - 50, 175 + 150, fill=color)
    canvas.create_text(700, 177 + 150, text=random.randint(0, 350), font=('Arial', 15))
    canvas.create_rectangle(310, 210 + 150, 310 + random.randint(0, 350) + 5, 235 + 150, fill=color2)
    canvas.create_text(700, 222.5 + 150, text=random.randint(0, 350), font=('Arial', 15))

    canvas.create_text(517.5, 145 + 150, text='Teleop Cubes', font=('Arial', 15))


    canvas.create_rectangle(310, 200 + 300, 310 + random.randint(0, 350) - 50, 175 + 300, fill=color)
    canvas.create_text(700, 177 + 300, text=random.randint(0, 350), font=('Arial', 15))
    canvas.create_rectangle(310, 210 + 300, 310 + random.randint(0, 350) + 5, 235 + 300, fill=color2)
    canvas.create_text(700, 222.5 + 300, text=random.randint(0, 350), font=('Arial', 15))

    canvas.create_text(517.5, 145 + 300, text='Teleop Cones', font=('Arial', 15))


    canvas.create_rectangle(310, 200 + 450, 310 + random.randint(0, 350) - 50, 175 + 450, fill=color)
    canvas.create_text(700, 177 + 450, text=random.randint(0, 350), font=('Arial', 15))
    canvas.create_rectangle(310, 210 + 450, 310 + random.randint(0, 350) + 5, 235 + 450, fill=color2)
    canvas.create_text(700, 222.5 + 450, text=random.randint(0, 350), font=('Arial', 15))

    canvas.create_text(517.5, 145 + 450, text='Endgame', font=('Arial', 15))


def teamcard(padding, segmentHeight, segmentWidth, segmentPadding, topPadding, offset, teamBoxOffsetx, teamBoxOffsety, teamBoxInitOffsetY, teamBoxHeight, teamBoxWidth, teamBoxItY, color, color2):
    percent = 0
    for y in range(4):
        ...
        for i in range(3):
            ...
            for x in range(3):
                if y == 0:
                    ...
                    percent = ''
                canvas.create_text(padding + segmentPadding + offset + teamBoxOffsetx + (teamBoxWidth * x) + (teamBoxWidth / 2), ((segmentHeight + segmentPadding) * i) + topPadding + teamBoxOffsety + teamBoxInitOffsetY + (y * teamBoxItY) + (teamBoxHeight / 2), text=f'{random.randint(0, 50)}{percent}', font=('Arial', 12))

    for i in range(3):
            canvas.create_text(padding + segmentPadding + offset + 112.5,
                                    ((segmentHeight + segmentPadding) * i) + topPadding + segmentHeight - 15, text=random.randint(0, 9999), font=('Arial', 12))
...
canvas.create_text(517.5, 70, text=f'Match {matchNum}', font=('Arial', 20))
...
teamcard(40, 225, 225, 10, 50, 0, 70, 20, 20, 20, 40, 40, '#add8e6', '#42e3f5')

teamcard(40, 225, 225, 10, 50, 700, 70, 20, 20, 20, 40, 40, '#add8e6', '#42e3f5')

bars('#42e3f5', 'red')

canvas.create_rectangle(300, 70, 400, 100, fill='#42e3f5')
canvas.create_text(350, 85, text=f'{random.randint(0, 350)}|{random.randint(0, 350)}|{random.randint(0, 350)}', font=('Arial', 15))


canvas.create_rectangle(620, 70, 720, 100, fill='red')
canvas.create_text(670, 85, text=f'{random.randint(0, 350)}|{random.randint(0, 350)}|{random.randint(0, 350)}', font=('Arial', 15))
